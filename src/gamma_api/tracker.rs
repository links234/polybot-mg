...
pub enum TrackerCommand {
    ...
    GetStorageStats {
        response: oneshot::Sender<Result<HashMap<String, crate::gamma_api::storage::UserStorageStats>>>,
    },
...
impl GammaTracker {
    ...
    async fn handle_get_storage_stats(&self) -> Result<HashMap<String, crate::gamma_api::storage::UserStorageStats>> {
