...
pub async fn fetch_and_cache_markets(
    clob_client: &polymarket_rs_client::ClobClient,
) -> Result<MarketCache> {
    ...
    println!(
        "{}",
        format!("  ✓ Fetched {} markets from CLOB API", clob_markets.len()).bright_green()
    );
    ...
    println!(
        "{}",
        format!("  ✓ Fetched {} markets from Gamma API", gamma_markets.len()).bright_green()
    );
    ...
    println!(
        "{}",
        format!("  ✓ Cached {} markets to disk", cache.markets.len()).bright_green()
    );
...
async fn fetch_clob_markets(
    client: &polymarket_rs_client::ClobClient,
